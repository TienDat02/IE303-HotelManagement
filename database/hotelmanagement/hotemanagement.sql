...
CREATE TABLE `checkout` (
  ...
  `Total_Time` decimal(9,3) DEFAULT NULL,
  `Employee_ID` bigint NOT NULL,
  `Room_ID` smallint NOT NULL,
  PRIMARY KEY (`Checkout_ID`),
  KEY `checkout-room_idx` (`Room_ID`),
  KEY `checkout-guest_idx` (`Guest_ID`),
  KEY `checkout-employee_idx` (`Employee_ID`),
  CONSTRAINT `checkout-room` FOREIGN KEY (`Room_ID`) REFERENCES `room` (`Room_ID`)
...
INSERT INTO `guest` VALUES (123456789012,'Nguyễn Văn A',2000,'012345654',NULL);
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `reservation-guest` FOREIGN KEY (`Guest_ID`) REFERENCES `guest` (`Guest_ID`)
...
INSERT INTO `reservation` VALUES (10,123456789012,NULL,101,20520437,NULL);
...
INSERT INTO `room` VALUES (101,'King',1000,'Đặt trước',1),(102,'Queen',1000,'Trống',1),(103,'Prince',1000,'Trống',1);
...
CREATE TABLE `room_service` (
  ...
  CONSTRAINT `Service-RoomService` FOREIGN KEY (`Service_ID`) REFERENCES `service` (`Service_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service` (
  ...
  `Serivce_Price` decimal(9,3) NOT NULL,
  `Service_Description` varchar(200) DEFAULT NULL,
  `Service_Status` enum('Trống','Bận') NOT NULL,
  PRIMARY KEY (`Service_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Đơn vị: Ngàn';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-19 15:55:54
